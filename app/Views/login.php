			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?= base_url('home/aksi_login/?')?>"method="post">
					<span class="login100-form-logo">
						<img class="login100-form-logo" src="<?= base_url('../images/stuff/yan.png')?>" alt="img logo">
					</span>
					...
					<div class="container-login100-form-btn">
						...
						<a href="<?=base_url('/home/register')?>"><button type="button" class="login100-form-btn">Register</button></a>
					</div>
